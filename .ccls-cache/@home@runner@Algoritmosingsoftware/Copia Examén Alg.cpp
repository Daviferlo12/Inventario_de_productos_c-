...
#include<algorithm>
/*
Una cadena de farmacias distribuida entre diferentes ciudades. Cada farmacia tiene sus empleados propios y un farmacéutico. 
Por cada ciudad existe un único farmacéutico; esto es, si en una ciudad hubiera más de una farmacia, el mismo farmacéutico estaría afectado a todas las farmacias de esa ciudad. Cada farmacia tiene a su vez su stock de medicamentos. El mismo se mantiene por medicamento y presentación. 

Los medicamentos se organizan según la o las mono drogas que lo componen, su presentación (por ejemplo ampollas de 5 unidades, jarabe de 100ml, inyecciones  por  10  unidades,  pomada  60gr,  etc.), el  laboratorio  que  lo  comercializa,  y  su  acción terapéutica (analgésico, antibiótico, etc.).  

Por cada medicamento se mantiene su precio y la cantidad en existencia del mismo. El sistema deberá permitir consultar la base de datos de diferentes alternativas para medicamentos compuestos por una mono droga, medicamentos de un laboratorio, presentaciones de un medicamento, entre otras.
...
Nota 4: no puedo vender mas de la cantidad permitida en stock por medicamento por ejemplo stock = 10, si se compran más de este valor el ejercicio está mal. Se pierde la nota. Solo se puede si se va a comprar en la segunda sucursal.
...
Nota8. Imprimir el nombre del usuario(cedula), nombre del farmacéutico, los medicamentos que compro+ el valor y el descuento si lo tiene  (solo un producto) 
...
void show_products(vector<Productos> productos){
  ...
  for(int i = 0; i < productos.size(); i++) {
    ...
    cout << "\n| "<< productos[i].id << "   | " << 
                  ...
                  setw(15) << productos[i].descuento << " | " <<
                  setw(15) <<productos[i].stock << " |\n";
...
int main() {
  ...
  // FARMACIAS PRIMERA CIUDAD
    ...
    san_vicente.push_back(add_inventory(1, "Acetaminofén 500 mg Frasco x 24 Tabletas", "Analgésico/antipirético", " TECNOQUÍMICAS S.A. ", 20.95, "10%" ,0.90, 8));
    ...
    la_y.push_back(add_inventory(2, "Shampoo Tío Nacho Anticaída Aclarante x 1 lt", "Antiséptico, Antiseborreico ","Tío Nacho " , 43.45, "10%" ,0.90, 13));
    ...
    la_y.push_back(add_inventory(4, "Alcohol Mk Antiséptico Uso Externo x 700 ml", "Antiséptico ","TECNOQUIMICAS S.A. " , 8.95, "10%" ,0.90, 11));
    la_y.push_back(add_inventory(5, "Cura Cure Band Standard Translúcidas x 30 und", "Adhesivos y botiquín ","Cure band " , 4.5, "10%" ,0.90, 17));
    la_y.push_back(add_inventory(6, "Advil Gripa x 10 capsulas", "Analgésico", " Pfizer S.A.S. " , 16.95, "10%" ,0.90, 2));
    la_y.push_back(add_inventory(7, "Mareol Caja x 12 Tabletas", "Antitusivo", " Pfizer S.A.S. " , 7.95, "10%" ,0.90, 20));
    la_y.push_back(add_inventory(8, "Leche Magnesia MK Frasco x 120ml", "Antiácidos / Laxantes", " ASPEN COLOMBIANA SAS " , 8.35, "10%" ,0.90, 13));
    la_y.push_back(add_inventory(9, "Pedialyte Max Zinc Uva Frasco x 500 ml", "rehidratación ", " Abbott " , 6.5, "10%" ,0.90, 18));
    la_y.push_back(add_inventory(10, "SAL DE FRUTAS LUA PLUS CAJA X 20 SOB", "Antiflatulento", " TECNOQUÍMICAS S.A. " , 54.9, "10%" ,0.90, 10));
  ...
  //FARMACIAS SEGUNDA CIUDAD
    ...
    medallo.push_back(add_inventory(4, "Shampoo Tío Nacho Anticaída Aclarante x 1 lt", "Antiséptico, Antiseborreico ","Tío Nacho " , 43.7, "10%" ,0.90, 20));
...
//FARMACIAS TERCER CIUDAD
  ...
  //Creacion inventario farmacia la rebaja
    ...
    la_rebaja.push_back(add_inventory(2, "Shampoo Tío Nacho Anticaída Aclarante x 1 lt", "Antiséptico, Antiseborreico ","Tío Nacho " , 42.0, "30%" ,0.70, 8));
          ...
          vector<Productos> sucursal;
            ...
            while(keep_buying == true){
              ...
              if(search_product(sucursal, _option) == true){
                ...
                // VALIDAR CANTIDAD
                if(cantidad <= product_selected.stock){
                  ...
                  carrito.push_back(add_inventory(product_selected.id, 
                                                  ...
                                                  (((product_selected.precio) * product_selected.descuento_num) * 1000) * cantidad,
                  ...
                  cout << "[*] ERROR: LA CANTIDAD SOLICITADA EXCEDE EL LIMITE...\n";
                  system("sleep 3s");
                }
